        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="text-lg max-w-prose mx-auto">
            ...
            <p className="mt-8 text-xl text-gray-500 leading-8">
              {`Welcome to https://vinna.io/. The https://vinna.io/ website (the
              "Site") is comprised of various web pages operated by Vinna.io
              ("Vinna"). https://vinna.io/ is offered to you conditioned on your
              acceptance without modification of the terms, conditions, and
              notices contained herein (the "Terms"). Your use of
              https://vinna.io/ constitutes your agreement to all such Terms.
          ...
          <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
            <div>
              {`https://vinna.io/ is a News and Information Site. To bring data
              from blockchain and cryptocurrencies, along with crypto wallets to
            ...
            <div>
              ...
              {`Visiting https://vinna.io/ or sending emails to Vinna constitutes
            ...
            <div>
              ...
              {`Vinna does not knowingly collect, either online or offline,
              personal information from persons under the age of thirteen. If
              you are under 18, you may use https://vinna.io/ only with
            ...
            <div>
              ...
              {`https://vinna.io/ may contain links to other websites ("Linked
              Sites"). The Linked Sites are not under the control of Vinna and
              Vinna is not responsible for the contents of any Linked Site,
              including without limitation any link contained in a Linked Site,
              or any changes or updates to a Linked Site. Vinna is providing
              these links to you only as a convenience, and the inclusion of any
              link does not imply endorsement by Vinna of the site or any
              association with its operators.`}
            </div>
            <blockquote>
              <div>
                {`Certain services made available via https://vinna.io/ are
                delivered by third party sites and organizations. By using any
                product, service or functionality originating from the
                https://vinna.io/ domain, you hereby acknowledge and consent
                that Vinna may share such information and data with any third
                party with whom Vinna has a contractual relationship to provide
                the requested product, service or functionality on behalf of
                https://vinna.io/ users and customers.`}
              </div>
            </blockquote>
            <div>
              {`No Unlawful or Prohibited Use/Intellectual Property You are
              granted a non-exclusive, non-transferable, revocable license to
              access and use https://vinna.io/ strictly in accordance with these
              terms of use. As a condition of your use of the Site, you warrant
              to Vinna that you will not use the Site for any purpose that is
            ...
            <div>
              ...
              any software used on the Site, is the property of Vinna or its
            ...
            <div>
              ...
              on the Site. Vinna content is not for resale. Your use of the Site
              ...
              of Vinna and the copyright owner. You agree that you do not
              ...
              property of Vinna or our licensors except as expressly authorized
              by these Terms.`}
            </div>
            <div>
              <h2 className="text-xl mt-6 text-gray-800">
              ...
              or unlawful topic, name, material or information; upload files
              ...
              laws or regulations. Vinna has no obligation to monitor the
              Communication Services. However, Vinna reserves the right to
              review materials posted to a Communication Service and to remove
              any materials in its sole discretion. Vinna reserves the right to
              terminate your access to any or all of the Communication Services
              at any time without notice for any reason whatsoever. Vinna
              ...
              any information or materials, in whole or in part, in Vinna's sole
              ...
              Communication Service. Vinna does not control or endorse the
              content, messages or information found in any Communication
              Service and, therefore, Vinna specifically disclaims any liability
              with regard to the Communication Services and any actions
              resulting from your participation in any Communication Service.
              Managers and hosts are not authorized Vinna spokespersons, and
              their views do not necessarily reflect those of Vinna. Materials
              ...
              materials. Materials Provided to https://vinna.io/ or Posted on
              Any Vinna Web Page Vinna does not claim ownership of the materials
              you provide to https://vinna.io/ (including feedback and
              suggestions) or post, upload, input or submit to any Vinna Site or
              our associated services (collectively "Submissions"). However, by
              posting, uploading, inputting, providing or submitting your
              Submission you are granting Vinna, our affiliated companies and
              ...
              in connection with your Submission. No compensation will be paid
              with respect to the use of your Submission, as provided herein.
              Vinna is under no obligation to post or use any Submission you may
              provide and may remove any Submission at any time in Vinna's sole
              ...
              rights necessary for you to provide, post, upload, input or submit
              the Submissions.`}
            </div>
            <div>
              <h2 className="text-xl mt-6 text-gray-800">
              ...
              {`The Service is controlled, operated and administered by Vinna from
              ...
              all local laws. You agree that you will not use the Vinna Content
              accessed through https://vinna.io/ in any country or in any manner
              prohibited by any applicable laws, restrictions or regulations.`}
            </div>
            <div>
              <h2 className="text-xl mt-6 text-gray-800">Indemnification</h2>
              {`You agree to indemnify, defend and hold harmless Vinna, its
              ...
              applicable laws, rules or regulations. Vinna reserves the right,
              ...
              event you will fully cooperate with Vinna in asserting any
              available defenses.`}
            </div>
            <div>
              <h2 className="text-xl mt-6 text-gray-800">Arbitration</h2>
            ...
            <div>
              ...
              ACTION AGAINST THE OTHER. Further, unless both you and Vinna agree
            ...
            <div>
              ...
              INFORMATION HEREIN. VINNA.IO AND/OR ITS SUPPLIERS MAY MAKE
              IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME. VINNA.IO
              ...
              IS" WITHOUT WARRANTY OR CONDITION OF ANY KIND. VINNA.IO AND/OR ITS
              ...
              LAW, IN NO EVENT SHALL VINNA.IO AND/OR ITS SUPPLIERS BE LIABLE FOR
              ...
              LIABILITY OR OTHERWISE, EVEN IF VINNA.IO OR ANY OF ITS SUPPLIERS
            ...
            <div>
              ...
              {`Vinna reserves the right, in its sole discretion, to terminate
              ...
              State of Utah and you hereby consent to the exclusive jurisdiction
              and venue of courts in Utah in all disputes arising out of or
              ...
              these Terms, including, without limitation, this section. You
              agree that no joint venture, partnership, employment, or agency
              relationship exists between you and Vinna as a result of this
              agreement or use of the Site. Vinna's performance of this
              agreement is subject to existing laws and legal process, and
              nothing contained in this agreement is in derogation of Vinna's
              right to comply with governmental, court and law enforcement
              requests or requirements relating to your use of the Site or
              information provided to or gathered by Vinna with respect to such
              ...
              agreement between the user and Vinna with respect to the Site and
              ...
              and Vinna with respect to the Site. A printed version of this
            ...
            <div>
              <h2 className="text-xl mt-6 text-gray-800">Changes to Terms</h2>
              {`Vinna reserves the right, in its sole discretion, to change the
              Terms under which https://vinna.io/ is offered. The most current
              version of the Terms will supersede all previous versions. Vinna
              encourages you to periodically review the Terms to stay informed
              of our updates.`}
            </div>
            <div>
              <h2 className="text-xl mt-6 text-gray-800">Contact Us</h2>
              {`Vinna welcomes your questions or comments regarding the Terms:
              Vinna.io 3239 S Iron Hill Cir Saratoga Springs, Utah 84045 Email
              Address: contact@vinna.io Telephone number: 3852252263 Effective
              as of December 09, 2021`}
            </div>
          </div>
        </div>
      </div>
